...
function validateForm() {
  ...
  if (Name == "" ) {
   document.getElementById("errorname").innerHTML="Please fill name";
    //return false;
  }
  else{
 ...
 {
   document.getElementById("errorpass").innerHTML="Password contains 6 character";
   // return false;
  }
  else 
  {
  ...
  if (comment.length<20) {
    document.getElementById("errorcomment").innerHTML="Comment contains 20 character";
    // return false;
   }
   else 
   {
   ...
   {
     document.getElementById("errorgen").innerHTML="Gender requried";
    // return false;
   }
   else{
   ...
   if(!get("Singing").checked && !get("Dancing").checked && !get("Reading").checked){
    hasError=true;
    document.getElementById("errorhobby").innerHTML="One Hobby must requried";
    return false;
}
